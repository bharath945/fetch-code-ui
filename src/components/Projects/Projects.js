...
export default function Projects() {
    return (
        <div className="projects">
            ...
            <ContentBelowCard title='CRM Implementation and Integration' subTitle='Successfully integrated and implemented comprehensive CRM solutions, streamlining customer management and driving sales growth.' image={process.env.PUBLIC_URL + "images/bg-image8.png"}/>
